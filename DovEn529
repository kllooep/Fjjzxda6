...
local redzlib = {
	...
	["Color Hub 1"] = ColorSequence.new({
		...
		ColorSequenceKeypoint.new(0.50, Color3.fromRGB(35, 70, 35)),
		ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 25, 15))
	}),
	["Color Hub 2"] = Color3.fromRGB(20, 40, 20),
	["Color Stroke"] = Color3.fromRGB(80, 200, 120),
	["Color Theme"] = Color3.fromRGB(50, 200, 80),
	["Color Text"] = Color3.fromRGB(180, 255, 180),
	["Color Dark Text"] = Color3.fromRGB(120, 200, 120)
},
		Dark = {
	["Color Hub 1"] = ColorSequence.new({
		ColorSequenceKeypoint.new(0.00, Color3.fromRGB(10, 25, 10)),
		ColorSequenceKeypoint.new(0.50, Color3.fromRGB(35, 70, 35)),   
		ColorSequenceKeypoint.new(1.00, Color3.fromRGB(60, 255, 120))
	}),
	["Color Hub 2"] = Color3.fromRGB(20, 40, 20),          
	...
	["Color Text"] = Color3.fromRGB(180, 255, 180),        
	["Color Dark Text"] = Color3.fromRGB(120, 200, 120),   
	["Color Dark Purple"] = Color3.fromRGB(0, 100, 0),     
	["Color Hub 9"] = Color3.fromRGB(0, 0, 0, 0),          
	["Color Dark Greem"] = Color3.fromRGB(0, 255, 128)     
},
		Purple = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(27.5, 25, 30)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(32.5, 32.5, 32.5)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 182, 193))
			}),
			["Color Hub 2"] = Color3.fromRGB(30, 30, 30),
			["Color Stroke"] = Color3.fromRGB(40, 40, 40),
			["Color Theme"] = Color3.fromRGB(214, 31, 110),
			["Color Text"] = Color3.fromRGB(255, 138, 196),
			["Color Dark Text"] = Color3.fromRGB(180, 180, 180),
			["Color Dark Purple"] = Color3.fromRGB(255, 182, 193),
			["Color Hub 9"] = Color3.fromRGB(0, 0, 0, 0),
...
local function CreateCyberpunkParticle()
	...
	local particleColor = Theme and Theme["Color Theme"] or Color3.fromRGB(255,255,255)
	...
	Glow.BackgroundColor3 = particleColor
...
local function UpdateCyberpunkParticles()
	for i = #ActiveParticles, 1, -1 do
		...
		if elapsed >= ParticleConfig.ParticleLifetime or p.Frame.Position.Y.Offset < -20 then
			-- Fade Out
			TweenService:Create(p.Frame, TweenInfo.new(0.3), {
				BackgroundTransparency = 1
			}):Play()

			TweenService:Create(p.Glow, TweenInfo.new(0.3), {
				BackgroundTransparency = 1
			}):Play()
...
local function SpawnCyberpunkSystem()
	...
	if tick() - LastSpawn >= ParticleConfig.SpawnRate then
		LastSpawn = tick()
		CreateCyberpunkParticle()
	end
end

if _G.ParticleSystemConnection then
	_G.ParticleSystemConnection:Disconnect()
end

_G.ParticleSystemConnection = RunService.Heartbeat:Connect(function()
...
--Font 
			local ButtonIcon = Create("ImageLabel", FButton, {
				...
				AnchorPoint = Vector2.new(1, 0.5),
				BackgroundTransparency = 1,
				Image = "rbxassetid://100672151994398"
})
